        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CaNumber = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EpiDeliveries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EpiDeliveries_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EpiDeliveries_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EpiTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryItems_EpiTypes_EpiTypeId",
                        column: x => x.EpiTypeId,
                        principalTable: "EpiTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EpiDeliveryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EpiTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryItems_EpiDeliveries_EpiDeliveryId",
                        column: x => x.EpiDeliveryId,
                        principalTable: "EpiDeliveries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeliveryItems_EpiTypes_EpiTypeId",
                        column: x => x.EpiTypeId,
                        principalTable: "EpiTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryItems_EpiTypeId",
                table: "DeliveryItems",
                column: "EpiTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_TenantId_RegistrationNumber",
                table: "Employees",
                columns: new[] { "TenantId", "RegistrationNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EpiDeliveries_EmployeeId",
                table: "EpiDeliveries",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_EpiDeliveries_TenantId",
                table: "EpiDeliveries",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_EpiTypes_TenantId_Code",
                table: "EpiTypes",
                columns: new[] { "TenantId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InventoryItems_EpiTypeId",
                table: "InventoryItems",
                column: "EpiTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryItems_TenantId_EpiTypeId",
                table: "InventoryItems",
                columns: new[] { "TenantId", "EpiTypeId" },
                unique: true);
